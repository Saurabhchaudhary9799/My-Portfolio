    ...
    <section className="education-section  my-10 flex flex-col gap-y-10 md:flex-row md:gap-x-10">
      <div>
        ...
        <div className="content flex flex-col gap-y-5  border-l-2 pl-4">
          <div className=" relative bg-[#171f38] text-[#777] p-2 before:content-[''] before:absolute before:w-[16px] before:h-[16px] before:rounded-[50%] before:top-0 before:right-[calc(100%+10px)] before:bg-[#11a372]  ">
